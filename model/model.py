...
def generate_model(opt):
    ...
    assert opt.model_name in ['resnet', 'preresnet', 'wideresnet', 'resnext']
    ...
    if opt.model_name == 'resnet':
        ...
        assert opt.model_depth in [10, 50, 101, 152]
        ...
        if opt.model_depth == 50:
            ...
            model = resnext.resnet10(num_classes=opt.n_classes, shortcut_type=opt.resnet_shortcut, cardinality=opt.resnext_cardinality,
                                      sample_size=opt.sample_size, sample_duration=opt.sample_duration,
                                      last_fc=last_fc)
        elif opt.model_depth == 101:
